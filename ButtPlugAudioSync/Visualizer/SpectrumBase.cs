    ...
    public class SpectrumBase : INotifyPropertyChanged
    {
        ...
        public int MinimumFrequency
        {
            ...
            set
            {
                ...
                RaisePropertyChanged(nameof(MinimumFrequency));
            }
        }
        ...
        public ISpectrumProvider SpectrumProvider
        {
            ...
            set
            {
                ...
                RaisePropertyChanged(nameof(SpectrumProvider));
            }
        }
        ...
        public bool IsXLogScale
        {
            ...
            set
            {
                _isXLogScale = value;
                UpdateFrequencyMapping();
                RaisePropertyChanged(nameof(IsXLogScale));
            }
        }
        ...
        public bool UseAverage
        {
            ...
            {
                _useAverage = value;
                RaisePropertyChanged(nameof(UseAverage));
            }
        }
